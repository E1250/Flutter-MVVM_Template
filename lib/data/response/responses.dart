...
@JsonSerializable()
class ForgetPassResponse extends BaseResponse{
  @JsonKey(name: "support")
  String? support;

  ForgetPassResponse(this.support);

  // from json
  factory ForgetPassResponse.fromJson(Map<String,dynamic> json) => _$ForgetPassResponseFromJson(json);
  // to json
